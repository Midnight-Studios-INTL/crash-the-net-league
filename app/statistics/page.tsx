...
export default async function StatisticsPage() {
  ...
  // For now, we'll show basic player info since we don't have detailed stats yet
  // In a real implementation, you'd have separate stats tables
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">
              View player and team statistics for the Crash the Net League
            </p>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="bg-card border rounded-lg p-6">
              <p className="text-muted-foreground text-center py-8">
                Team statistics will be available once teams are added to the database.
              </p>
            </div>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="bg-card border rounded-lg p-6">
              <p className="text-muted-foreground text-center py-8">
                Goalie statistics will be available once goalies are added to the database.
              </p>
            </div>
          </div>
          ...
          {players.length === 0 && (
            <div className="text-center py-12">
              ...
              <p className="text-muted-foreground">
                Statistics will be available once players and teams are added to the database.
              </p>
            </div>
          )}
        </div>
